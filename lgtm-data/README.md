...
1. [新たなデザインテーマの企画](#新たなデザインテーマの企画)
1. [開発環境を整える](#開発環境を整える)
1. [新たなファイルを作成する](#新たなファイルを作成する)
1. [作成したファイルに、テンプレートを貼り付ける](#作成したファイルにテンプレートを貼り付ける)
1. [変更を加え、独自のデザインデータを作成する](#変更を加え独自のデザインデータを作成する)
...
なので、[Issues](https://github.com/lgtm-factory/lgtm-factory/issues) に提案されたデザインテーマがあれば、コーディング作業のみを行う事もできます！

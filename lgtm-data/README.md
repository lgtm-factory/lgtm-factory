...
- [どのように LGTM Factory にデザインテーマを追加すればいいの？](#どのように-lgtm-factory-にデザインテーマを追加すればいいの)
  ...
  - [2.開発環境を整える](#1開発環境を整える)
  - [3.新たなファイルを作成する](#2新たなファイルを作成する)
...
LGTM Factory に、デザインテーマを追加する方法、大きく２通りあります：

- 新たなデザインテーマを提案し、他のコントリビューターがコーディングを行う
- デザインとコーディングの両方を行う

上記のどちらの場合であっても、<br>
**デザインの作成・提案の時点で、メンテナーからのフィードバックを受けることができます**！

- その場合は、イシューを作成してください: [デザイン提案用テンプレート]()を使用できます
- イシューを作成することで、コーディング作業は、別のコントリビューターに割り当てる事が、可能になります
- 同様に、[Issues](https://github.com/lgtm-factory/lgtm-factory/issues) に提案されたデザインテーマがあれば、コーディング作業のみを行う事もできます！

> 新たなデザインテーマを提案し、他のコントリビューターがコーディングを行う

上記の場合は、デザイン提案のイシューを作成することで、作業は完了です🥳
コーディング作業を行う場合は、次のステップへ進みます！！
